...
_ROUTE_PROFILES: dict[tuple[str, str], dict[str, Any]] = {
    ...
    ("qwen_image_21", "diffusion_model"): {
        **DEFAULT_PROFILE,
        "profile_id": "qwen_image_21_components_highres",
        "family_group": "qwen_image_21",
        "model_kind": "qwen_image_21_components",
        "rollout_state": "experimental_available",
        "default_strategy": "forge_pixel_refine",
        "allowed_strategies": ["forge_pixel_refine", "standard", "upscale_only"],
        "blocked_strategies": ["ultimate_sd_upscale", "qwen_reedit"],
        "snap_multiple": 32,
        ...
        "cfg_policy": "preserve_base_sampler_cfg",
        "sampler_policy": "preserve_base_sampler",
        "latent_policy": "qwen21_preserve_reference_and_mask_semantics",
        "anchor_policy": "detect_qwen21_model_sampler_vae_decode",
        "hidden_controls": ["cfg", "ultimate_sd_upscale"],
        "recommended_presets": {
            "balanced_finish": {"steps": 10, "denoise": 0.20, "cfg_policy": "preserve_base_sampler_cfg"},
            "detail_push": {"steps": 14, "denoise": 0.28, "cfg_policy": "preserve_base_sampler_cfg"},
            "latent_rebuild": {"steps": 16, "denoise": 0.38, "cfg_policy": "preserve_base_sampler_cfg"},
        },
        "notes": [
            "Q21-5 enables High-Res Lab on Qwen Image 2.1 without rebuilding TextEncodeQwenImage21 conditioning; ordered reference conditioning remains attached to the base sampler inputs.",
            "True CFG remains owned by the base Q21 sampler (normally 1.0); High-Res Lab does not inject SD-style CFG.",
            "Q21 masked routes resize and reapply the base noise mask in Stage 2; strict preservation modes composite the refined masked area over the scaled Stage-1 final image.",
            "Ultimate SD Upscale and legacy qwen_reedit are blocked because they do not own the Q21 1-10 reference and mask contracts.",
        ],
    },
    ("qwen_image_21", "gguf"): {
        **DEFAULT_PROFILE,
        "profile_id": "qwen_image_21_gguf_highres",
        "family_group": "qwen_image_21",
        "model_kind": "qwen_image_21_gguf",
        "rollout_state": "experimental_available",
        "default_strategy": "forge_pixel_refine",
        "allowed_strategies": ["forge_pixel_refine", "standard", "upscale_only"],
        "blocked_strategies": ["ultimate_sd_upscale", "qwen_reedit"],
        ...
        "cfg_policy": "preserve_base_sampler_cfg",
        "sampler_policy": "preserve_base_sampler",
        "latent_policy": "qwen21_preserve_reference_semantics",
        "anchor_policy": "detect_qwen21_gguf_model_sampler_vae_decode",
        "hidden_controls": ["cfg", "ultimate_sd_upscale"],
        "recommended_presets": {
            "balanced_finish": {"steps": 10, "denoise": 0.20, "cfg_policy": "preserve_base_sampler_cfg"},
            "detail_push": {"steps": 14, "denoise": 0.28, "cfg_policy": "preserve_base_sampler_cfg"},
        ...
        "notes": [
            "Q21-5 exposes High-Res Lab for the active Q21 GGUF txt2img/img2img/edit routes while preserving native Qwen3-VL/VAE conditioning.",
            "GGUF High-Res remains physically unqualified until a real Qwen Image 2.1 GGUF model is tested.",
            "Masked GGUF Q21 routes remain unsupported by the base route matrix and therefore stay unavailable here.",
        ],
    },
    ...
    ("qwen_image_edit_2511", "diffusion_model"): {
        **DEFAULT_PROFILE,
        "profile_id": "qwen_2511_components_highres",
        "family_group": "qwen_2511",
        "model_kind": "qwen_2511_components",
        "rollout_state": "available",
        "default_strategy": "forge_pixel_refine",
        "allowed_strategies": ["forge_pixel_refine", "standard", "upscale_only", "qwen_reedit"],
        "blocked_strategies": ["ultimate_sd_upscale"],
        "snap_multiple": 16,
        "negative_prompt_policy": "preserve_route_conditioning",
        "cfg_policy": "qwen_2511_safe_low_cfg",
        "sampler_policy": "preserve_base_sampler",
        "latent_policy": "warn_low_denoise_qwen_2511",
        "anchor_policy": "detect_qwen_2511_edit_model_sampler_vae_decode",
        "hidden_controls": ["ultimate_sd_upscale"],
        "recommended_presets": {
            "balanced_finish": {"steps": 10, "denoise": 0.22, "cfg": 3.0},
            "detail_push": {"steps": 14, "denoise": 0.30, "cfg": 3.5},
        ...
        "notes": [
            "Phase 18.1 promotes Qwen Image Edit 2511 Safetensors / Components for High-Res Lab using the same native edit sampler/model/VAE anchors already proven by the base compiler.",
            "2511 keeps 1-3 source policy for img2img/edit at the base route; High-Res Lab patches the compiled route without downgrading to normal qwen_image or 2509.",
            "Ultimate SD Upscale remains blocked because it assumes SD-style conditioning semantics.",
        ],
    },
    ("qwen_image_edit_2511", "gguf"): {
        **DEFAULT_PROFILE,
        "profile_id": "qwen_2511_gguf_highres",
        "family_group": "qwen_2511",
        "model_kind": "qwen_2511_gguf",
        "rollout_state": "available",
        "default_strategy": "forge_pixel_refine",
        "allowed_strategies": ["forge_pixel_refine", "standard", "upscale_only", "qwen_reedit"],
        "blocked_strategies": ["ultimate_sd_upscale"],
        ...
        "sampler_policy": "preserve_base_sampler",
        "latent_policy": "warn_low_denoise_qwen_2511",
        "anchor_policy": "detect_qwen_2511_gguf_model_sampler_vae_decode",
        "hidden_controls": ["ultimate_sd_upscale"],
        "recommended_presets": {
            "balanced_finish": {"steps": 10, "denoise": 0.22, "cfg": 3.0},
            "detail_push": {"steps": 14, "denoise": 0.30, "cfg": 3.5},
        ...
        "notes": [
            "Phase 18.1 promotes Qwen Image Edit 2511 GGUF for High-Res Lab using the provider-owned 2511 GGUF edit sampler/model/VAE anchors.",
            "2511 GGUF keeps 1-3 source policy for img2img/edit at the base route; High-Res Lab never falls back to 2509 or normal qwen_image.",
            "Ultimate SD Upscale remains blocked because it assumes SD-style conditioning semantics.",
        ],
    },
    ("krea2", "diffusion_model"): {
        **DEFAULT_PROFILE,
        "profile_id": "krea2_raw_components_highres",
        "family_group": "krea2",
        "model_kind": "krea2_raw_components",
        "rollout_state": "experimental_available",
        "default_strategy": "forge_pixel_refine",
        "allowed_strategies": ["forge_pixel_refine", "standard", "upscale_only"],
        "blocked_strategies": ["ultimate_sd_upscale", "qwen_reedit"],
        ...
        "cfg_policy": "preserve_base_sampler_cfg",
        "sampler_policy": "preserve_base_sampler",
        "latent_policy": "warn_low_denoise_krea2",
        "anchor_policy": "detect_krea2_model_sampler_vae_decode",
        "hidden_controls": ["cfg", "ultimate_sd_upscale"],
        "recommended_presets": {
            "balanced_finish": {"steps": 12, "denoise": 0.22, "cfg_policy": "preserve_base_sampler_cfg"},
            "detail_push": {"steps": 16, "denoise": 0.30, "cfg_policy": "preserve_base_sampler_cfg"},
            "latent_rebuild": {"steps": 18, "denoise": 0.42, "cfg_policy": "preserve_base_sampler_cfg"},
        },
        "notes": [
            "Krea 2 RAW uses its compiled model, sampler, Qwen3-VL conditioning, and Qwen Image VAE anchors.",
            "CFG stays owned by the base Krea route; SD-style Ultimate SD Upscale remains blocked.",
        ],
    },
    ("krea2", "gguf"): {
        **DEFAULT_PROFILE,
        "profile_id": "krea2_raw_gguf_highres",
        "family_group": "krea2",
        "model_kind": "krea2_raw_gguf",
        "rollout_state": "experimental_available",
        "default_strategy": "forge_pixel_refine",
        "allowed_strategies": ["forge_pixel_refine", "standard", "upscale_only"],
        "blocked_strategies": ["ultimate_sd_upscale", "qwen_reedit"],
        ...
        "cfg_policy": "preserve_base_sampler_cfg",
        "sampler_policy": "preserve_base_sampler",
        "latent_policy": "warn_low_denoise_krea2_gguf",
        "anchor_policy": "detect_krea2_gguf_model_sampler_vae_decode",
        "hidden_controls": ["cfg", "ultimate_sd_upscale"],
        "recommended_presets": {
            "balanced_finish": {"steps": 10, "denoise": 0.20, "cfg_policy": "preserve_base_sampler_cfg"},
            "detail_push": {"steps": 14, "denoise": 0.28, "cfg_policy": "preserve_base_sampler_cfg"},
            "latent_rebuild": {"steps": 16, "denoise": 0.40, "cfg_policy": "preserve_base_sampler_cfg"},
        },
        "notes": [
            "Krea 2 RAW GGUF keeps the native Qwen3-VL text encoder and Qwen Image VAE while refining through the selected GGUF transformer.",
            "CFG stays owned by the base Krea route; SD-style Ultimate SD Upscale remains blocked.",
        ],
    },
    ("krea2_turbo", "diffusion_model"): {
        **DEFAULT_PROFILE,
        "profile_id": "krea2_turbo_components_highres",
        "family_group": "krea2_turbo",
        "model_kind": "krea2_turbo_components",
        "rollout_state": "experimental_available",
        "default_strategy": "forge_pixel_refine",
        "allowed_strategies": ["forge_pixel_refine", "standard", "upscale_only"],
        ...
        "cfg_policy": "preserve_base_sampler_cfg",
        "sampler_policy": "preserve_base_sampler",
        "latent_policy": "warn_low_denoise_krea2_turbo",
        "anchor_policy": "detect_krea2_turbo_model_sampler_vae_decode",
        "hidden_controls": ["cfg", "ultimate_sd_upscale"],
        "recommended_presets": {
            "balanced_finish": {"steps": 6, "denoise": 0.18, "cfg_policy": "preserve_base_sampler_cfg"},
            "detail_push": {"steps": 8, "denoise": 0.24, "cfg_policy": "preserve_base_sampler_cfg"},
            "latent_rebuild": {"steps": 10, "denoise": 0.34, "cfg_policy": "preserve_base_sampler_cfg"},
        },
        "notes": [
            "Krea 2 Turbo keeps its low-step sampler and zeroed negative-conditioning policy.",
            "CFG stays fixed by the compiled route; SD-style Ultimate SD Upscale remains blocked.",
        ],
    },
    ("krea2_turbo", "gguf"): {
        **DEFAULT_PROFILE,
        "profile_id": "krea2_turbo_gguf_highres",
        "family_group": "krea2_turbo",
        "model_kind": "krea2_turbo_gguf",
        "rollout_state": "experimental_available",
        "default_strategy": "forge_pixel_refine",
        "allowed_strategies": ["forge_pixel_refine", "standard", "upscale_only"],
        "blocked_strategies": ["ultimate_sd_upscale", "qwen_reedit", "detail_push_sd"],
        ...
        "cfg_policy": "preserve_base_sampler_cfg",
        "sampler_policy": "preserve_base_sampler",
        "latent_policy": "warn_low_denoise_krea2_turbo_gguf",
        "anchor_policy": "detect_krea2_turbo_gguf_model_sampler_vae_decode",
        "hidden_controls": ["cfg", "ultimate_sd_upscale"],
        "recommended_presets": {
            "balanced_finish": {"steps": 5, "denoise": 0.18, "cfg_policy": "preserve_base_sampler_cfg"},
            "detail_push": {"steps": 8, "denoise": 0.23, "cfg_policy": "preserve_base_sampler_cfg"},
            "latent_rebuild": {"steps": 10, "denoise": 0.32, "cfg_policy": "preserve_base_sampler_cfg"},
        },
        "notes": [
            "Krea 2 Turbo GGUF keeps the low-step Turbo sampler while preserving native Qwen3-VL conditioning.",
            "CFG stays fixed by the compiled route; SD-style Ultimate SD Upscale remains blocked.",
        ],
    },
