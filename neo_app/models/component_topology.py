...
ROLE_SPECS: dict[str, dict[str, Any]] = {
    ...
    "qwen21_vae": {"field_id": "vae", "label": "Qwen Image 2.1 VAE", "catalog": "vaes"},
    ...
    "qwen21_text_encoder": {"field_id": "qwen_text_encoder", "label": "Qwen3-VL 8B Text Encoder", "catalog": "qwen_text_encoders"},
