...
def compile_lanpaint_flux1_inpaint(
    *,
    ...
    if requested_guidance < guidance_min or requested_guidance > guidance_max:
        validation.warnings.append(f"Flux.1 {variant} guidance {requested_guidance:g} is outside the recommended LanPaint range {guidance_min:g}-{guidance_max:g}; Neo preserves the explicit user value.")
