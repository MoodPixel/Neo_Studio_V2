...
class VideoRoute:
    ...
    def payload(self) -> dict:
        data = asdict(self)
        data["parameter_profile"] = deepcopy(self.parameter_profile)
        data["enabled"] = self.status == "enabled"
        data["experimental"] = self.status == "experimental"
        data["planned"] = self.status == "planned"
        data["selectable"] = self.status in VIDEO_ROUTE_SELECTABLE_STATUSES
        data["runnable"] = self.status in VIDEO_ROUTE_RUNNABLE_STATUSES
        return data
...
VIDEO_ROUTES: Final[tuple[VideoRoute, ...]] = (
    VideoRoute(
        ...
        {'width': 832, 'height': 480, 'frames': 41, 'fps': 16, 'steps': 20, 'guidance': 5, 'sampler': 'uni_pc', 'scheduler': 'simple', 'decode_mode': 'standard', 'tile_size': 512},
 ...
 'guidance': 3.5,
 'split_step': 6,
 'first_test_preset': {'width': 512, 'height': 288, 'frames': 25, 'fps': 12, 'steps': 4, 'guidance': 1.0, 'split_step': 2},
 'sampler': 'euler',
 'scheduler': 'simple',
 'source_image_required': True,
 'image_strength': 0.7,
 ...
 'chunk_feed_forward': 2},
    ...
    VideoRoute("ltx23.unet.txt2vid", "ltx23", "unet", "txt2vid", "enabled", "V8", False, ("Safetensors diffusion/UNET LTX path. Useful where GGUF is not selected.",), {'width': 768,
 'height': 512,
 'frames': 97,
 'fps': 24,
 'steps': 8,
 ...
 'tiled_vae_decode': True,
 'chunk_feed_forward': 2}),
    VideoRoute("ltx23.unet.img2vid", "ltx23", "unet", "img2vid", "enabled", "V9", False, ("Safetensors diffusion/UNET LTX image-guided path.",), {'width': 768,
 'height': 512,
 'frames': 97,
 'fps': 24,
 'steps': 8,
 ...
 'chunk_feed_forward': 2}),
    ...
    VideoRoute("ltx23.gguf.first_last_frame", "ltx23", "gguf", "first_last_frame", "enabled", "V15", False, ("Controlled transition between two Video source images using LTXVAddGuideMulti.", "Requires first_image and last_image."), {'width': 768,
 'height': 512,
 'frames': 97,
 'fps': 24,
 'steps': 8,
 ...
 'sampler': 'euler_ancestral',
 'scheduler': 'ltxv',
 'first_image_required': True,
 'last_image_required': True,
 'transition_strength': 0.75,
 'first_strength': 0.75,
 'last_strength': 0.75,
 'decode_mode': 'tiled',
 'tile_size': 384,
 'temporal_tile_size': 4096,
 'tiled_vae_decode': True,
 'chunk_feed_forward': 2}, ("DualCLIPLoaderGGUF", "LTXVAddGuideMulti", "LTXVCropGuides", "VAEDecodeTiled")),
    VideoRoute("ltx23.unet.first_last_frame", "ltx23", "unet", "first_last_frame", "enabled", "V15", False, ("Controlled transition between two Video source images using LTXVAddGuideMulti.", "Uses LTX UNET/Diffusion safetensors route."), {'width': 768,
 'height': 512,
 'frames': 97,
 'fps': 24,
 'steps': 8,
 ...
 'temporal_tile_size': 4096,
 'tiled_vae_decode': True,
 'chunk_feed_forward': 2}, ("DualCLIPLoader", "LTXVAddGuideMulti", "LTXVCropGuides", "VAEDecodeTiled")),
    VideoRoute("ltx23.gguf.multiscene", "ltx23", "gguf", "multiscene", "enabled", "V16", False, ("Segment cards, image guides, frame math, and LTXVAddGuideMulti are active in V16.", "Requires at least two segment images."), {'width': 768,
 'height': 512,
 'frames': 97,
 'fps': 24,
 'steps': 8,
 ...
 'tiled_vae_decode': True,
 'chunk_feed_forward': 2}, ("DualCLIPLoaderGGUF", "LTXVAddGuideMulti", "LTXVCropGuides", "VAEDecodeTiled")),
    VideoRoute("ltx23.unet.multiscene", "ltx23", "unet", "multiscene", "enabled", "V16", False, ("Safetensors LTX MultiScene path with 2-4 image guides.", "Requires at least two segment images."), {'width': 768,
 'height': 512,
 'frames': 97,
 'fps': 24,
 'steps': 8,
 ...
 'tiled_vae_decode': True,
 'chunk_feed_forward': 2}, ("DualCLIPLoader", "LTXVAddGuideMulti", "LTXVCropGuides", "VAEDecodeTiled")),
    VideoRoute("ltx23.gguf.extend", "ltx23", "gguf", "extend", "enabled", "V17", False, ("Extends an existing Neo-owned video by extracting the last frame as an LTX continuation guide.", "Creates a child output under the extend category; parent video is untouched."), {'width': 768,
 'height': 512,
 'frames': 97,
 'fps': 24,
 'steps': 8,
 ...
 'temporal_tile_size': 4096,
 'tiled_vae_decode': True,
 'chunk_feed_forward': 2}, ("VHS_LoadVideo", "GetImageFromBatch", "DualCLIPLoaderGGUF", "LTXVAddGuide", "LTXVCropGuides", "VAEDecodeTiled")),
    VideoRoute("ltx23.unet.extend", "ltx23", "unet", "extend", "enabled", "V17", False, ("Safetensors LTX Extend path using a source video final-frame guide.", "Creates a child output under the extend category; parent video is untouched."), {'width': 768,
 'height': 512,
 'frames': 97,
 'fps': 24,
 'steps': 8,
 ...
 'temporal_tile_size': 4096,
 'tiled_vae_decode': True,
 'chunk_feed_forward': 2}, ("VHS_LoadVideo", "GetImageFromBatch", "DualCLIPLoader", "LTXVAddGuide", "LTXVCropGuides", "VAEDecodeTiled")),
    VideoRoute("ltx23.gguf.vid2vid", "ltx23", "gguf", "vid2vid", "enabled", "V18", False, ("Restyles or cleans up a Neo-owned source video using encoded source latents.", "Creates a non-destructive child output under the vid2vid category."), {'width': 768,
 'height': 512,
 'frames': 97,
 'fps': 24,
 'steps': 8,
 ...
 'temporal_tile_size': 4096,
 'tiled_vae_decode': True,
 'chunk_feed_forward': 2}, ("VHS_LoadVideo", "VAEEncodeTiled", "DualCLIPLoaderGGUF", "LTXVConditioning", "LTXVCropGuides", "VAEDecodeTiled")),
    VideoRoute("ltx23.unet.vid2vid", "ltx23", "unet", "vid2vid", "enabled", "V18", False, ("Safetensors LTX Video-to-Video path using encoded source latents.", "Creates a non-destructive child output under the vid2vid category."), {'width': 768,
 'height': 512,
 'frames': 97,
 'fps': 24,
 'steps': 8,
 ...
 'temporal_tile_size': 4096,
 'tiled_vae_decode': True,
 'chunk_feed_forward': 2}, ("VHS_LoadVideo", "VAEEncodeTiled", "DualCLIPLoader", "LTXVConditioning", "LTXVCropGuides", "VAEDecodeTiled")),

    VideoRoute("ltx23.gguf.depth_motion", "ltx23", "gguf", "depth_motion", "enabled", "V19", False, ("Depth / Motion Control route using external depth preprocessors and LTX guide attachment.", "Requires a Neo-owned source video and depth/motion nodes such as DepthAnythingV2 or DepthCrafter."), {'width': 768,
 'height': 512,
 'frames': 97,
 'fps': 24,
 'steps': 8,
 ...
 'temporal_tile_size': 4096,
 'tiled_vae_decode': True,
 'chunk_feed_forward': 2}, ("VHS_LoadVideo", "GetImageFromBatch", "DepthAnythingV2", "DepthCrafter", "LTXVAddGuide", "LTXVCropGuides", "VAEDecodeTiled")),
    VideoRoute("ltx23.unet.depth_motion", "ltx23", "unet", "depth_motion", "enabled", "V19", False, ("Safetensors LTX Depth / Motion Control route using selected result video as guidance source.", "Requires a Neo-owned source video and depth/motion nodes such as DepthAnythingV2 or DepthCrafter."), {'width': 768,
 'height': 512,
 'frames': 97,
 'fps': 24,
 'steps': 8,
 ...
 'chunk_feed_forward': 2}, ("VHS_LoadVideo", "GetImageFromBatch", "DepthAnythingV2", "DepthCrafter", "LTXVAddGuide", "LTXVCropGuides", "VAEDecodeTiled")),
    ...
    VideoRoute("ltx23.gguf.prompt_schedule", "ltx23", "gguf", "prompt_schedule", "enabled", "V20", False, ("Timeline-style prompt and motion scheduling using LTX prompt-beat metadata.", "Requires at least one prompt or motion event; FizzNodes integration remains optional/detection-only."), {'width': 768,
 'height': 512,
 'frames': 97,
 'fps': 24,
 'steps': 8,
 ...
 'sampler': 'euler_ancestral',
 'scheduler': 'ltxv',
 'prompt_events_required': True,
 'motion_events_supported': True,
 'schedule_mode': 'metadata_guided',
 'decode_mode': 'tiled',
 'tile_size': 384,
 'temporal_tile_size': 4096,
 'tiled_vae_decode': True,
 'chunk_feed_forward': 2}, ("DualCLIPLoaderGGUF", "LTXVConditioning", "LTXVScheduler", "VAEDecodeTiled")),
    VideoRoute("ltx23.unet.prompt_schedule", "ltx23", "unet", "prompt_schedule", "enabled", "V20", False, ("Safetensors LTX Prompt/Motion Schedule path using prompt-beat metadata.", "Requires at least one prompt or motion event; FizzNodes integration remains optional/detection-only."), {'width': 768,
 'height': 512,
 'frames': 97,
 'fps': 24,
 'steps': 8,
 ...
 'temporal_tile_size': 4096,
 'tiled_vae_decode': True,
 'chunk_feed_forward': 2}, ("DualCLIPLoader", "LTXVConditioning", "LTXVScheduler", "VAEDecodeTiled")),

    VideoRoute("ltx23.gguf.audio_video", "ltx23", "gguf", "audio_video", "enabled", "V21", False, ("Audio-Video route using LTX prompt-conditioned audio intent, dialogue, soundscape, and sync metadata.", "Audio nodes are detected but not hard-wired until local ComfyUI node signatures are stable."), {'width': 768,
 'height': 512,
 'frames': 97,
 'fps': 24,
 'steps': 8,
 ...
 'tiled_vae_decode': True,
 'chunk_feed_forward': 2}, ("DualCLIPLoaderGGUF", "LTXVConditioning", "LTXVScheduler", "VAEDecodeTiled")),
    VideoRoute("ltx23.unet.audio_video", "ltx23", "unet", "audio_video", "enabled", "V21", False, ("Safetensors LTX Audio-Video route with prompt-conditioned audio intent and replay metadata.", "Audio nodes are detected but not hard-wired until local ComfyUI node signatures are stable."), {'width': 768,
 'height': 512,
 'frames': 97,
 'fps': 24,
 'steps': 8,
...
VIDEO_ROUTE_SELECTABLE_STATUSES: Final[frozenset[str]] = frozenset({"enabled", "experimental"})
VIDEO_ROUTE_RUNNABLE_STATUSES: Final[frozenset[str]] = frozenset({"enabled", "experimental"})
VIDEO_ROUTE_VISIBLE_STATUSES: Final[frozenset[str]] = frozenset({"enabled", "experimental", "planned"})
...
def route_parameter_profile(route_id: str | None) -> dict[str, Any]:
    rid = str(route_id or "").strip()
    if not rid:
        return {}
    route = next((item for item in VIDEO_ROUTES if item.route_id == rid), None)
    return deepcopy(route.parameter_profile) if route else {}
...
def active_route_records(*, include_planned: bool = True) -> list[VideoRoute]:
    return [route for route in VIDEO_ROUTES if include_planned or route.status in VIDEO_ROUTE_SELECTABLE_STATUSES]
...
def generation_options_for_route(family: str | None, loader: str | None) -> tuple[VideoRouteOption, ...]:
    ...
    type_ids = []
    for route in VIDEO_ROUTES:
        if route.family == nf and route.loader == nl and route.status in VIDEO_ROUTE_VISIBLE_STATUSES and route.generation_type not in type_ids:
...
def video_route_matrix_payload() -> dict:
    ...
    return {
        "schema_version": "neo.video.route_matrix.v3",
        "authority": "neo_app.video.route_matrix",
        "selectable_statuses": sorted(VIDEO_ROUTE_SELECTABLE_STATUSES),
        "runnable_statuses": sorted(VIDEO_ROUTE_RUNNABLE_STATUSES),
        "surface": "video",
...
def video_route_validation_payload(family: str | None = None, loader: str | None = None, generation_type: str | None = None) -> dict:
    ...
    experimental = bool(route and route.status == "experimental")
    planned = bool(route and route.status == "planned")
    selectable = bool(route and route.status in VIDEO_ROUTE_SELECTABLE_STATUSES)
    runnable = bool(route and route.status in VIDEO_ROUTE_RUNNABLE_STATUSES)
    compatible = bool(route)
    fallback = find_video_route(nf, nl, "txt2vid", include_planned=False) or find_video_route(nf, "unet", "txt2vid", include_planned=False) or find_video_route("wan22", "unet", "txt2vid", include_planned=False)
    return {
        "schema_version": "neo.video.route_validation.v3",
        "surface": "video",
        "release_stage": "public_preview",
        ...
        "message": (
            f"Route {route.route_id} is enabled and runnable." if enabled and route else
            f"Route {route.route_id} is experimental, selectable, and runnable with experimental safeguards." if experimental and route else
            f"Route {route.route_id} is known but planned; keep Generate disabled." if planned and route else
