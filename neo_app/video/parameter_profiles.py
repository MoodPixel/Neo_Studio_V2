...
BASE_FIELDS: Final[tuple[VideoParameterField, ...]] = (
    ...
    VideoParameterField("model_name", "Model", "models", "backend_select", "", route_scope=("wan22", "ltx23"), description="Primary diffusion/video model from the live ComfyUI model catalog for the selected route."),
    VideoParameterField("clip_name", "Text Encoder", "models", "backend_select", "", route_scope=("wan22", "ltx23"), description="Primary text encoder from the live ComfyUI text-encoder catalog."),
    VideoParameterField("clip_name2", "Text Projection / Encoder B", "models", "backend_select", "", route_scope=("ltx23",), description="Optional second text encoder/projection used by LTX routes that require it."),
    VideoParameterField("vae_name", "VAE", "models", "backend_select", "", route_scope=("wan22", "ltx23"), description="Video VAE from the live ComfyUI VAE catalog."),
...
H3_FIELDS: Final[tuple[VideoParameterField, ...]] = (
    ...
    VideoParameterField("h3_ref_image_size", "Reference Image Size", "h3", "select", "match", route_scope=("minimax_h3.unet.reference_to_video", "minimax_h3.gguf.reference_to_video", "minimax_h3.unet.vid2vid", "minimax_h3.gguf.vid2vid"), description="match is faster/lower memory; max keeps larger reference tokens for identity fidelity."),
