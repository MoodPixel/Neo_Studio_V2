...
VIDEO_EXTERNAL_NODE_PACKS: Final[tuple[VideoExternalNodePack, ...]] = (
    ...
    VideoExternalNodePack(
        pack_id="comfyui_gguf",
        display_name="ComfyUI-GGUF",
        category="model_loader",
        purpose="GGUF model/text-encoder loaders for experimental MiniMax H3 GGUF routes and other quantized Video workflows.",
        repo_url="https://github.com/city96/ComfyUI-GGUF",
        aliases=("UnetLoaderGGUF", "UNETLoaderGGUF", "CLIPLoaderGGUF"),
        phase_target="V12/H3",
        install_role="optional",
        risk="medium",
        route_lanes=("minimax_h3", "gguf", "experimental"),
        notes=("Required only for H3 GGUF lanes. Native safetensors H3 routes do not depend on it.",),
    ),
    VideoExternalNodePack(
        pack_id="minimax_h3_spectrum",
        display_name="Spectrum MiniMax H3",
        category="h3_acceleration",
        purpose="Approximate feature-forecast acceleration for native MiniMax H3 sampling.",
        repo_url="https://github.com/xmarre/ComfyUI-Spectrum-MiniMax-H3",
        aliases=("SpectrumApplyMiniMaxH3",),
        phase_target="V12/H3",
        install_role="experimental",
        risk="high",
        route_lanes=("minimax_h3", "performance", "experimental"),
        notes=("Optional approximate accelerator. Neo keeps it mutually exclusive with T8 BlockCache.", "Quality-critical work should A/B against the native H3 path."),
    ),
    VideoExternalNodePack(
        pack_id="minimax_h3_blockcache_t8",
        display_name="MiniMax H3 BlockCache T8",
        category="h3_acceleration",
        purpose="Experimental H3 transformer block-residual cache acceleration.",
        repo_url="https://github.com/T8mars/comfyui-minimax-h3-blockcache-T8",
        aliases=("MiniMaxH3BlockCacheT8", "MiniMax H3 Block Cache (T8)"),
        phase_target="V12/H3",
        install_role="experimental",
        risk="high",
        route_lanes=("minimax_h3", "performance", "experimental"),
        notes=("Optional approximate accelerator. Neo does not stack it with Spectrum on the same H3 branch.",),
    ),
    VideoExternalNodePack(
        pack_id="kjnodes_h3",
        display_name="KJNodes · H3 helpers",
        category="h3_optimization",
        purpose="Optional Sage Attention / MiniMax H3 helper nodes used by advanced local workflows.",
        repo_url="https://github.com/kijai/ComfyUI-KJNodes",
        aliases=("MiniMaxH3MemoryEfficientSageAttentionPatch", "PathchSageAttentionKJ", "PatchSageAttentionKJ", "Model Preview Override"),
        phase_target="V12/H3",
        install_role="optional",
        risk="medium",
        route_lanes=("minimax_h3", "performance", "preview"),
        notes=("Optional optimization/preview helpers; never required for the native H3 base route.",),
    ),
    VideoExternalNodePack(
        pack_id="qwenvl",
