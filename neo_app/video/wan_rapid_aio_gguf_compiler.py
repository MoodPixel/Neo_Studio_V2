...
def _build_prompt_api_variant(
    ...
    return {
        ...
        "generation_graph": {
            ...
            "video_lora_stack": generation_graph.get("video_lora_stack", {}),
            "lora_patch_profile": generation_graph.get("lora_patch_profile", {}),
        },
        ...
        **matrix,
        ...
        "warnings": [
            ...
            *(vace_dimension_guard.get("warnings", []) if isinstance(vace_dimension_guard.get("warnings"), list) else []),
            ...
            "WAN Rapid AIO standard and speed Video LoRAs use the universal single-model stack; high/low branch targets remain dual-noise-only.",
        ],
