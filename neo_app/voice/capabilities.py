...
FAMILY_CAPABILITIES: dict[str, dict[str, Any]] = {
    ...
    "qwen3_tts_06b_custom_voice": {
        **BASE_FEATURES,
        ...
        "saved_voice_profiles": True,
        "emotion": False,
        "recommended_tier": "qwen3_tts_06b_provisional",
        "adapter_phase": "QWEN3-TTS-P4",
        "backend_profile_id": "voice.neo_engine",
        "backend_label": "Qwen3-TTS 0.6B CustomVoice",
        "backend_badge": "Local / Physical Test Ready",
        "physical_adapter": False,
        "physical_test_ready": True,
        "controls": ["language", "seed", "normalize", "silence_trim", "loudness_target", "convert_audio", "split_chunks", "merge_chunks", "replay_metadata", "memory_export"],
        "notes": ["Phase 4 exposes this model in the normal Voice TTS selector only when the isolated runtime and complete model snapshot are executable.", "Speaker and language are common Voice controls; upstream 0.6B CustomVoice does not accept Voice Instruction."],
    },
    "qwen3_tts_17b_custom_voice": {
        **BASE_FEATURES,
        ...
        "saved_voice_profiles": True,
        "emotion": True,
        "recommended_tier": "qwen3_tts_17b_provisional",
        "adapter_phase": "QWEN3-TTS-P4",
        "backend_profile_id": "voice.neo_engine",
        "backend_label": "Qwen3-TTS 1.7B CustomVoice",
        "backend_badge": "Local / UI Active When Installed",
        "physical_adapter": False,
        "physical_test_ready": True,
        "controls": ["language", "seed", "normalize", "silence_trim", "loudness_target", "convert_audio", "split_chunks", "merge_chunks", "replay_metadata", "memory_export"],
        "notes": ["Phase 4 exposes this model in normal TTS only when runtime/model probes are executable.", "Voice Instruction is model-scoped and appears only for 1.7B CustomVoice."],
    },
    "qwen3_tts_06b_base": {
        **BASE_FEATURES,
        "voice_clone": True,
        ...
        "saved_voice_profiles": True,
        "recommended_tier": "qwen3_tts_06b_provisional",
        "adapter_phase": "QWEN3-TTS-P3",
        "backend_profile_id": "voice.neo_engine",
        "backend_label": "Qwen3-TTS 0.6B Base",
        "backend_badge": "Local / Registry Active",
        "physical_adapter": False,
        "controls": ["language", "reference_strength", "seed", "normalize", "silence_trim", "loudness_target", "convert_audio", "split_chunks", "merge_chunks", "replay_metadata", "memory_export"],
        "notes": ["Phase 3 registers the Base clone route; ICL transcript vs x-vector-only controls remain normal-UI gated."],
    },
    "qwen3_tts_17b_base": {
        **BASE_FEATURES,
        "voice_clone": True,
        ...
        "adapter_phase": "QWEN3-TTS-P3",
        "backend_profile_id": "voice.neo_engine",
        "backend_label": "Qwen3-TTS 1.7B Base",
        "backend_badge": "Local / Registry Active",
        "physical_adapter": False,
        "controls": ["language", "reference_strength", "seed", "normalize", "silence_trim", "loudness_target", "convert_audio", "split_chunks", "merge_chunks", "replay_metadata", "memory_export"],
        "notes": ["Phase 3 registers the Base clone route; ICL transcript vs x-vector-only controls remain normal-UI gated."],
    ...
    "qwen3_tts_17b_voice_design": {
        **BASE_FEATURES,
        ...
        "adapter_phase": "QWEN3-TTS-P3",
        "backend_profile_id": "voice.neo_engine",
        "backend_label": "Qwen3-TTS 1.7B VoiceDesign",
        "backend_badge": "Registry Only / UI Gated",
        "physical_adapter": False,
        "controls": ["language", "seed", "normalize", "silence_trim", "loudness_target", "convert_audio", "split_chunks", "merge_chunks", "replay_metadata", "memory_export"],
        "notes": ["VoiceDesign is registry-declared but protocol/UI activation remains gated until Neo adds a dedicated voice-design request/source grammar."],
    },
    "kokoro_preview": {
        **BASE_FEATURES,
        "voice_clone": False,
